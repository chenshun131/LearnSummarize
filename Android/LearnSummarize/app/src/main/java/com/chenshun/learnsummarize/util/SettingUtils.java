...
/**
 * User: chenshun <p />
 * Time: 16/10/14 07:59  <p />
 * Version: V1.0  <p />
 * Description: 应用配置工具类 <p />
 */
public final class SettingUtils
{
    ...
    private static Method findApplyMethod()
    {
        ...
        {
            Logs.d(TAG, "Failed to retrieve Editor.apply(); probably doesn't exist on this phone's OS.  Using Editor.commit() instead.");
            return null;
        }
    }
    ...
    public static void commitOrApply(Editor editor)
    {
        if (APPLY_METHOD != null)
        {
            ...
            {
                Logs.d(TAG, "Failed while using Editor.apply().  Using Editor.commit() instead.");
            }
