...
/**
 * User: chenshun <p />
 * Time: 16/10/14 08:06  <p />
 * Version: V1.0  <p />
 * Description: 创建删除快捷图标，需要权限: com.android.launcher.permission.INSTALL_SHORTCUT com.android.launcher.permission.UNINSTALL_SHORTCUT <p />
 */
public final class ShortCutUtils
{
    ...
    public static void addShortcut(Activity activity)
    {
        ...
        // 快捷方式的图标
        Intent.ShortcutIconResource iconRes = Intent.ShortcutIconResource.fromContext(activity, R.drawable.ic_launcher);
