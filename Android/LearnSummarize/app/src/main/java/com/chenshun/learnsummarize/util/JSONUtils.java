...
/**
 * User: chenshun <p />
 * Time: 16/10/13 17:40  <p />
 * Version: V1.0  <p />
 * Description: Json解析工具类 推荐使用阿里巴巴的FastJSON，速度比Google的GSON和Android自带的JSON解析工具都好 <p />
 */
public final class JSONUtils
{
     ...
     * <li>if jsonObject is null, return defaultValue</li>
     * <li>if jsonData {@link JSONObject#JSONObject(String)} exception, return defaultValue</li>
     * <li>return {@link JSONUtils#getJSONArray(String, String, JSONObject)}</li>
     * </ul>
     */
