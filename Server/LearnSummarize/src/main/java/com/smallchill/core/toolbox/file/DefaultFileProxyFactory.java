...
public class DefaultFileProxyFactory implements IFileProxy
{
    ...
    {
        StringBuilder newFileName = new StringBuilder().append(getFileDir(Cst.me().getUploadRealPath())).append(System.currentTimeMillis()).append(getFileExt(f.getName()));
    ...
    {
        StringBuilder newFileName = new StringBuilder().append(getFileDir(Cst.me().getUploadCtxPath())).append(System.currentTimeMillis()).append(getFileExt(f.getName()));
        return newFileName.toString();
    }
